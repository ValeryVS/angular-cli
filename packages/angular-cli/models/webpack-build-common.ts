...
export function getWebpackCommonConfig(
 ...
        {
          test: /\.json$/,
          loader: `json-loader?name=${appConfig.assetsOutDir}/[hash].[ext]`
        },
        {
          test: /\.(jpg|png|gif)$/,
 ...
        {
          test: /\.html$/,
          loader: `raw-loader?name=${appConfig.assetsOutDir}/[hash].[ext]`
        },
        {
        ...
        {
          test: /\.(eot|svg)$/,
          loader: `file-loader?name=${appConfig.assetsOutDir}/[hash].[ext]`
        }
      ]
    },
    plugins: [
